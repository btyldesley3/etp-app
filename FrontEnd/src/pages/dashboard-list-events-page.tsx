              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex space-x-2">
                  ...
                  <div>
                    <p className="font-medium">
                      {formatDate(eventItem.startDateAndTime)} to{" "}
                      {formatDate(eventItem.endDateAndTime)}
                    </p>
                    <p className="text-gray-400">
                      {formatTime(eventItem.startDateAndTime)} -{" "}
                      {formatTime(eventItem.endDateAndTime)}
                    </p>
                  </div>
                </div>
                {/* Sales start and end */}
                <div className="flex space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      {formatDate(eventItem.saleStartDateAndTime)} to{" "}
                      {formatDate(eventItem.saleEndDateAndTime)}
                    </p>
                  </div>
                </div>
                <div className="flex space-x-2">
