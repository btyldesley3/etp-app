...
import com.ticketplatform.tickets.domain.dtos.ErrorDto;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EventOrganizerAccessException.class)
    public ResponseEntity<ErrorDto> handleEventOrganizerAccessException(EventOrganizerAccessException ex) {
        log.error("Caught EventOrganizerAccessException", ex);
        ErrorDto errorDto = new ErrorDto();
        errorDto.setError("Organizer does not have permission to delete this event");
        return new ResponseEntity<>(errorDto, HttpStatus.BAD_REQUEST);
    }
    ...
    //General handle exception method which all others will be derived from
